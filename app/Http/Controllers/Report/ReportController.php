...
class ReportController extends Controller
{
    ...
    public function show(Request $request) {
        ...
        $sales = Sales::whereBetween('updated_at', [$dateStart, $dateEnd]) -> where('sales_status', 'paid');
        ...
        -> with('totalSales', $sales -> sum('total_price')) -> with('sales', $sales -> paginate(5));
    }

    public function export(Request $request) {
        return Excel::download(new SalesReportExport($request->dateStart, $request->dateEnd), 'salesReport.xlsx');
    }
}
